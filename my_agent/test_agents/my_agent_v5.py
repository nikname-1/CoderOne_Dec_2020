...
class agent:
    ...
    def next_move(self, game_state, player_state):
        ...
        self.search(game_state,cost,player_state.location, (1,1))
    ...
    def search(self,game_state, cost, start, end):
        ...
        outer_iterations = 0
        max_iterations = (game_state.size[0]//2)**4
        ...
        while len(yet_to_visit_list) > 0:
            ...
            if outer_iterations > max_iterations or self.actually_occupied(end):
